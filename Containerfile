...
LABEL name="workbench-images:jupyter-minimal-c9s-py311_2024a_20240408" \
    ...
    io.openshift.build.image="https://quay.io/opendatahub-contrib/workbench-images:jupyter-minimal-c9s-py311_2024a_20240408"
...
RUN sed -i "s/RELEASE/2024a/" /opt/app-root/share/jupyter/metadata/runtime-images/*.json 
